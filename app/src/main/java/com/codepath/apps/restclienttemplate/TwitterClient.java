...
public class TwitterClient extends OAuthBaseClient {
	...
	// here are all my API routes

	public void getHomeTimeline(JsonHttpResponseHandler handler) {
		Log.i("TwitterClient","getHomeTimeline");
		String apiUrl = getApiUrl("statuses/home_timeline.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("count", 120);
		params.put("since_id", 1);
		client.get(apiUrl, params, handler);
	}

	public void getMoreHomeTimeline(String max_id, JsonHttpResponseHandler handler) {
		Log.i("TwitterClient","getMoreHomeTimeline");
		String apiUrl = getApiUrl("statuses/home_timeline.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("count", 120);
	...
	public void publishReplyTweet(String tweetContent, String tweetID, JsonHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/update.json");
		// Can specify query string params directly or through RequestParams
		RequestParams params = new RequestParams();
		params.put("status", tweetContent);
	...
	public void getFollowers(String userID, Integer cursor, JsonHttpResponseHandler handler) {
	...
	public void getFollowings(String userID, Integer cursor, JsonHttpResponseHandler handler) {
